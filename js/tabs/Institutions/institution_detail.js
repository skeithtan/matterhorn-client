...
class InstitutionDetail extends Component {
    ...
    render() {
        ...
        const currentTab = this.state.activeTab.tab(this.props.institution, this.setSidebarContent, this.props.onDeleteActiveInstitution, this.props.performQuery, this.props.memorandumToBeAdded, this.props.toggleMemorandumToBeAdded);
