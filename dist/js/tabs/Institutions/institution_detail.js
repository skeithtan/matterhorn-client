...
var InstitutionDetail = function (_Component) {
    ...
    function InstitutionDetail(props) {
        ...
        _this.state = {
            activeTab: _this.props.memorandumToBeAdded ? _institution_tabs_list2.default[1] : _institution_tabs_list2.default[0],
            sidebarContent: null
        };
    ...
    _createClass(InstitutionDetail, [{
        ...
        value: function render() {
            ...
            var currentTab = this.state.activeTab.tab(this.props.institution, this.setSidebarContent, this.props.onDeleteActiveInstitution, this.props.refreshInstitutions, this.props.memorandumToBeAdded, this.props.toggleMemorandumToBeAdded);
