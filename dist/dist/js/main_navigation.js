...
var MainNavigation = function (_Component) {
    ...
    _createClass(MainNavigation, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactstrap.Navbar, { className: "bg-dlsu d-flex flex-column justify-content-center", id: "main-navigation" }, _react2.default.createElement(_reactstrap.Nav, { className: "d-flex flex-column w-100 mt-auto mb-auto" }, navItems), _react2.default.createElement(SwitchUserButton, null));
        }
    }]);
...
var TabItem = function (_Component2) {
    ...
    _createClass(TabItem, [{
        ...
        value: function activeTab() {
            return _react2.default.createElement(_reactstrap.NavItem, { className: "active", "data-toggle": "tooltip", "data-placement": "right", title: this.props.name }, _react2.default.createElement("img", { src: this.props.image, className: "sidebar-image" }));
        }
    }, {
        key: "inactiveTab",
        value: function inactiveTab() {
            return _react2.default.createElement(_reactstrap.NavItem, { "data-toggle": "tooltip", "data-placement": "right", title: this.props.name }, _react2.default.createElement("img", { src: this.props.image, className: "sidebar-image", onClick: this.props.setActiveTab }));
        }
    }, {
        key: "render",
        value: function render() {
...
var SwitchUserButton = function (_Component3) {
    ...
    _createClass(SwitchUserButton, [{
        ...
        key: "render",
        value: function render() {
            return _react2.default.createElement("div", { className: "w-100" }, _react2.default.createElement("div", { id: "switch-user-button", onClick: this.togglePopover }, _react2.default.createElement("h6", null, localStorage.username)), _react2.default.createElement(_reactstrap.Popover, { placement: "right", isOpen: this.state.popoverIsOpen, target: "switch-user-button",
                toggle: this.togglePopover }, _react2.default.createElement(_reactstrap.PopoverBody, null, _react2.default.createElement(_reactstrap.Button, { className: "bg-dlsu", onClick: _index2.default }, "Sign out"))));
        }
    }]);
