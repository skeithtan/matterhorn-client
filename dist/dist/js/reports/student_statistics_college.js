...
var CollegeStudentStatisticsReport = function (_Component) {
    ...
    _createClass(CollegeStudentStatisticsReport, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: "report-page" }, _react2.default.createElement(_reports.ReportHead, null), _react2.default.createElement(_reports.ReportTitleContainer, null, _react2.default.createElement("h4", null, "Distribution of International Students (IS) by College"), _react2.default.createElement("h5", null, "Academic Year " + year + " - " + (year + 1) + " Term " + this.props.term)), _react2.default.createElement(CollegeStudentStatisticsTable, { colleges: this.state.colleges }), _react2.default.createElement(_reports.EndOfReportIndicator, null));
        }
    }]);
...
var CollegeStudentStatisticsRow = function (_Component3) {
    ...
    _createClass(CollegeStudentStatisticsRow, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("tr", null, _react2.default.createElement("td", null, this.props.college.college), _react2.default.createElement("td", { className: "numeric text-right" }, gradSchool), _react2.default.createElement("td", { className: "numeric text-right" }, underGradSchool), _react2.default.createElement("td", { className: "numeric text-right" }, collegeTotal), _react2.default.createElement("td", { className: "numeric text-right" }, percentage, "%"));
        }
    }]);
