...
var StudentDistributionReport = function (_Component) {
    ...
    _createClass(StudentDistributionReport, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: "report-page" }, _react2.default.createElement(_reports.ReportHead, null), _react2.default.createElement(_reports.ReportTitleContainer, null, _react2.default.createElement("h4", null, "Term End Outbound and Inbound Students Distribution Report"), _react2.default.createElement("h5", null, "Academic Year " + year + " - " + (year + 1) + " Term " + this.props.term)), _react2.default.createElement(StudentDistributionTable, { institutions: this.state.institutions }), _react2.default.createElement(_reports.EndOfReportIndicator, null));
        }
    }]);
...
var StudentDistributionTable = function (_Component2) {
    ...
    _createClass(StudentDistributionTable, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactstrap.Table, null, _react2.default.createElement("thead", null, _react2.default.createElement("tr", { className: "text-center" }, _react2.default.createElement("th", null, "Institution"), _react2.default.createElement("th", null, "Outbound"), _react2.default.createElement("th", null, "Inbound"), _react2.default.createElement("th", null, "Deficit (-) / Surplus (+)"))), _react2.default.createElement("tbody", null, rows), _react2.default.createElement("tfoot", { className: "text-right" }, _react2.default.createElement("tr", null, _react2.default.createElement("th", null, "Total"), _react2.default.createElement("th", { className: "numeric" }, totalOutboundStudents), _react2.default.createElement("th", { className: "numeric" }, totalInboundStudents), _react2.default.createElement("th", { className: "numeric" }, totalDeficit))));
        }
    }]);
...
var StudentDistributionRow = function (_Component3) {
    ...
    _createClass(StudentDistributionRow, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("tr", null, _react2.default.createElement("td", null, this.props.institution.institution), _react2.default.createElement("td", { className: "numeric text-right" }, outboundStudentsCount), _react2.default.createElement("td", { className: "numeric text-right" }, inboundStudentsCount), _react2.default.createElement("td", { className: "numeric text-right" }, deficit));
        }
    }]);
