...
var DefaultUnitsReport = function (_Component) {
    ...
    _createClass(DefaultUnitsReport, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: "report-page" }, _react2.default.createElement(_reports.ReportHead, null), _react2.default.createElement(_reports.ReportTitleContainer, null, _react2.default.createElement("h4", null, "Term End Outbound and Inbound Students Distribution Report"), _react2.default.createElement("h5", null, "Academic Year " + year + " - " + (year + 1) + " Term " + this.props.term)), _react2.default.createElement(DefaultUnitsTable, { institutions: this.state.institutions }), _react2.default.createElement(_reports.EndOfReportIndicator, null));
        }
    }]);
...
var DefaultUnitsTable = function (_Component2) {
    ...
    _createClass(DefaultUnitsTable, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactstrap.Table, null, _react2.default.createElement("thead", null, _react2.default.createElement("tr", { className: "text-center" }, _react2.default.createElement("th", null, "Institution"), _react2.default.createElement("th", null, "Number of Students"), _react2.default.createElement("th", null, "Default Units"), _react2.default.createElement("th", null, "Total Units"), _react2.default.createElement("th", null, "Deficit (-) / Surplus (+)"))), _react2.default.createElement("tbody", null, rows), _react2.default.createElement("tfoot", { className: "text-right" }, _react2.default.createElement("tr", null, _react2.default.createElement("th", null, "Total"), _react2.default.createElement("th", { className: "numeric" }, totalStudents), _react2.default.createElement("th", { className: "numeric" }, totalDefault), _react2.default.createElement("th", { className: "numeric" }, grandTotalUnits), _react2.default.createElement("th", { className: "numeric" }, totalDeficit))));
        }
    }]);
...
var DefaultUnitsRow = function (_Component3) {
    ...
    _createClass(DefaultUnitsRow, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("tr", null, _react2.default.createElement("td", null, this.props.institution.institution), _react2.default.createElement("td", { className: "numeric text-right" }, students), _react2.default.createElement("td", { className: "numeric text-right" }, defaultUnits), _react2.default.createElement("td", { className: "numeric text-right" }, totalUnits), _react2.default.createElement("td", { className: "numeric text-right" }, deficit));
        }
    }]);
