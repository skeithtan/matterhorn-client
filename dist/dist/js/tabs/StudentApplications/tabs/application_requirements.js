...
var ApplicationRequirements = function (_Component) {
    ...
    _createClass(ApplicationRequirements, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: "d-flex flex-column p-0 h-100" }, _react2.default.createElement(ApplicationHead, { student: this.props.student }), _react2.default.createElement(RequirementsBody, { requirements: this.state.requirements,
...
var ApplicationHead = function (_Component2) {
    ...
    _createClass(ApplicationHead, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement("div", { className: "page-head pt-5 d-flex flex-row align-items-center" }, _react2.default.createElement("div", { className: "mr-auto" }, _react2.default.createElement("h5", { className: "mb-0 text-secondary" }, "Application Requirements"), _react2.default.createElement("h4", { className: "page-head-title justify-content-left d-inline-block mb-0 mr-2" }, this.props.student.first_name, " ", this.props.student.middle_name, " ", this.props.student.family_name, _react2.default.createElement("small", { className: "text-muted ml-2" }, this.props.student.id_number))));
        }
    }]);
...
var RequirementsBody = function (_Component3) {
    ...
    _createClass(RequirementsBody, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_section.SectionTable, null, rows);
        }
    }]);
...
var RequirementRow = function (_Component4) {
    ...
    _createClass(RequirementRow, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(_section.SectionRow, { large: true,
                className: "d-flex flex-row align-items-center" }, this.props.done && _react2.default.createElement("b", { className: "text-success" }, "\u2713"), _react2.default.createElement("p", { className: "lead mr-auto mb-0" }, this.props.requirement.name), this.props.done && _react2.default.createElement(_reactstrap.Button, { outline: true,
                color: "warning" }, "Mark as undone"), !this.props.done && _react2.default.createElement(_reactstrap.Button, { outline: true,
                color: "success" }, "Mark as done"));
        }
    }]);
