...
var Memorandums = function (_Component) {
    ...
    _createClass(Memorandums, [{
        ...
        value: function render() {
            return _react2.default.createElement("div", { className: "mb-4" }, _react2.default.createElement("small", { className: "section-title" }, "Memorandums"), _react2.default.createElement("div", { id: "memorandums-accordion" }, _react2.default.createElement(MemorandumsOfUnderstanding, { showing: this.state.showing === "MOU",
                memorandums: this.state.understandings,
                toggle: this.onUnderstandingClick }), _react2.default.createElement(MemorandumsOfAgreement, { showing: this.state.showing === "MOA",
                memorandums: this.state.agreements,
                toggle: this.onAgreementClick })), _react2.default.createElement("small", { className: "section-footer" }, "Select a memorandum type to reveal details."));
        }
    }]);
...
var MemorandumsOfUnderstanding = function (_Component2) {
    ...
    _createClass(MemorandumsOfUnderstanding, [{
        ...
        value: function emptyState() {
            return _react2.default.createElement("div", { className: "p-5 text-center text-muted" }, _react2.default.createElement("h5", { className: "mb-0" }, "There are no Memorandums of Understanding for this institution."));
        }
    }, {
        ...
        value: function getCollapseContent() {
            ...
            return _react2.default.createElement(_reactstrap.CardBody, { className: "pt-0" }, _react2.default.createElement("small", { className: "section-title" }, "Latest Memorandum"), _react2.default.createElement(MemorandumRow, { memorandum: this.state.latestMemorandum,
                ...
                } }), hasPreviousMemorandums && _react2.default.createElement("small", { className: "section-title" }, "Previous Memorandums"), previousMemorandums);
        }
    }, {
        key: "render",
        value: function render() {
            ...
            return _react2.default.createElement(_reactstrap.Card, null, _react2.default.createElement(_reactstrap.CardHeader, { className: cardHeaderClass, onClick: this.props.toggle }, _react2.default.createElement("h5", { className: "mr-auto mb-0" }, "Memorandums of Understanding"), _react2.default.createElement(_reactstrap.Button, { outline: true, size: "sm", color: "success", className: "add-memorandum-btn" }, "Add a new version")), _react2.default.createElement(_reactstrap.Collapse, { isOpen: this.props.showing }, this.getCollapseContent()));
        }
    }]);
...
var MemorandumsOfAgreement = function (_Component3) {
    ...
    _createClass(MemorandumsOfAgreement, [{
        key: "emptyState",
        value: function emptyState() {
            return _react2.default.createElement("div", { className: "p-5 text-center text-muted" }, _react2.default.createElement("h5", { className: "mb-0" }, "There are no Memorandums of Agreement for this institution."));
        }
    }, {
        key: "makeMemorandumShowing",
        value: function makeMemorandumShowing(memorandum) {
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactstrap.Card, null, _react2.default.createElement(_reactstrap.CardHeader, { className: cardHeaderClass, onClick: this.props.toggle }, _react2.default.createElement("h5", { className: "mr-auto mb-0" }, "Memorandums of Agreement"), _react2.default.createElement(_reactstrap.Button, { outline: true, size: "sm", color: "success", className: "add-memorandum-btn" }, "Add a new version")), _react2.default.createElement(_reactstrap.Collapse, { isOpen: this.props.showing }, this.getCollapseContent()));
        }
    }]);
...
var MemorandumRow = function (_Component4) {
    ...
    _createClass(MemorandumRow, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactstrap.Card, null, _react2.default.createElement(_reactstrap.CardHeader, { className: cardHeaderClass, onClick: this.props.toggle }, "Version ", versionDate), _react2.default.createElement(_reactstrap.Collapse, { isOpen: this.props.isOpen }, _react2.default.createElement(_reactstrap.CardBody, { className: "p-0" }, _react2.default.createElement(_reactstrap.ListGroup, null, _react2.default.createElement(MemorandumDetailRow, { fieldName: "Date Effective",
                fieldValue: dateEffective }), _react2.default.createElement(MemorandumDetailRow, { fieldName: "Date Expiration",
                fieldValue: dateExpiration }), _react2.default.createElement(MemorandumDetailRow, { fieldName: "College Initiator",
                fieldValue: collegeInitiator }), _react2.default.createElement(_reactstrap.ListGroupItem, null, _react2.default.createElement(_reactstrap.Button, { outline: true, color: "primary" }, "Open Memorandum Copy"))))));
        }
    }]);
...
var MemorandumDetailRow = function (_Component5) {
    ...
    _createClass(MemorandumDetailRow, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(_reactstrap.ListGroupItem, null, _react2.default.createElement("small", { className: "font-weight-bold" }, this.props.fieldName), _react2.default.createElement("p", { className: "lead mb-0" }, this.props.fieldValue));
        }
    }]);
