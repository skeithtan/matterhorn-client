...
var InstitutionOverview = function (_Component) {
    ...
    _createClass(InstitutionOverview, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement("div", { className: "d-flex flex-column p-0 h-100" }, _react2.default.createElement(OverviewHead, { institution: this.state.institution,
                onDeleteInstitution: this.props.onDeleteActiveInstitution,
                onEditInstitution: this.onEditInstitution }), _react2.default.createElement(OverviewBody, { institution: this.state.institution }));
        }
    }]);
...
var OverviewHead = function (_Component2) {
    ...
    _createClass(OverviewHead, [{
        ...
        key: "render",
        value: function render() {
            return _react2.default.createElement("div", { className: "page-head pt-5 d-flex flex-row align-items-end" }, _react2.default.createElement("div", { className: "mr-auto" }, _react2.default.createElement("h5", { className: "mb-0 text-secondary" }, "Overview"), _react2.default.createElement("h4", { className: "page-head-title mb-0" }, this.props.institution.name)), _react2.default.createElement("div", { className: "page-head-actions" }, _react2.default.createElement(_reactstrap.Button, { outline: true, size: "sm", color: "success", className: "mr-2",
                onClick: this.toggleEditInstitution }, "Edit Institution"), _react2.default.createElement(_reactstrap.Button, { outline: true, size: "sm", color: "danger",
                onClick: this.toggleDeleteInstitution }, "Delete")), _react2.default.createElement(_modals.DeleteInstitutionModal, { isOpen: this.state.deleteInstitutionIsShowing,
                institution: this.props.institution,
                toggle: this.toggleDeleteInstitution,
                refresh: this.props.onDeleteInstitution }), _react2.default.createElement(_modals.InstitutionFormModal, { edit: true,
...
var OverviewBody = function (_Component3) {
    ...
    _createClass(OverviewBody, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement("div", { className: "page-body" }, _react2.default.createElement(InstitutionDetails, { institution: this.props.institution }), _react2.default.createElement(ContactDetails, { institution: this.props.institution }));
        }
    }]);
...
var InstitutionDetails = function (_Component4) {
    ...
    _createClass(InstitutionDetails, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_section.Section, null, _react2.default.createElement(_section.SectionTitle, null, "Institution details"), _react2.default.createElement(_section.SectionTable, null, _react2.default.createElement(_section.SectionRow, null, _react2.default.createElement(_section.SectionRowTitle, null, "Address"), _react2.default.createElement(_section.SectionRowContent, { large: true }, institution.address)), _react2.default.createElement(_section.SectionRow, null, _react2.default.createElement(_section.SectionRowTitle, null, "Country"), _react2.default.createElement(_section.SectionRowContent, { large: true }, institution.country)), _react2.default.createElement(_section.SectionRow, null, _react2.default.createElement(_section.SectionRowTitle, null, "Website"), _react2.default.createElement(_section.SectionRowContent, { large: true, className: "text-primary",
                onClick: openWebsite }, website)), _react2.default.createElement(_section.SectionRow, null, _react2.default.createElement(_section.SectionRowTitle, null, "Agreement Type"), _react2.default.createElement(_section.SectionRowContent, { large: true }, agreementType))));
        }
    }]);
...
var ContactDetails = function (_Component5) {
    ...
    _createClass(ContactDetails, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_section.Section, null, _react2.default.createElement(_section.SectionTitle, null, "Contact Details"), _react2.default.createElement(_section.SectionTable, null, institution.contact_person_name.length > 0 && _react2.default.createElement(_section.SectionRow, null, _react2.default.createElement(_section.SectionRowTitle, null, "Contact Person"), _react2.default.createElement(_section.SectionRowContent, { large: true }, institution.contact_person_name)), institution.contact_person_email.length > 0 && _react2.default.createElement(_section.SectionRow, null, _react2.default.createElement(_section.SectionRowTitle, null, "Contact Person Email"), _react2.default.createElement(_section.SectionRowContent, { large: true }, institution.contact_person_email)), institution.contact_person_number.length > 0 && _react2.default.createElement(_section.SectionRow, null, _react2.default.createElement(_section.SectionRowTitle, null, "Contact Person Number"), _react2.default.createElement(_section.SectionRowContent, { large: true }, institution.contact_person_number))));
        }
    }]);
