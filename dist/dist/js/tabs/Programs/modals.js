    ...
    _createClass(AcademicYearFormModal, [{
        ...
        value: function render() {
            ...
            return _react2.default.createElement(_reactstrap.Modal, { isOpen: this.props.isOpen,
                ...
                backdrop: true }, _react2.default.createElement(_reactstrap.ModalHeader, { toggle: this.props.toggle }, this.props.edit ? "Edit " + academicYearFull : "Add an Academic Year"), _react2.default.createElement(_reactstrap.ModalBody, { className: "form" }, _react2.default.createElement(_reactstrap.Form, null, _react2.default.createElement(_reactstrap.FormGroup, null, _react2.default.createElement(_reactstrap.Label, null, "Academic Year Start"), _react2.default.createElement(_reactstrap.Input, { placeholder: "Academic Year Start",
                onChange: this.getYearChangeHandler(),
                valid: isValid("Academic year start"),
                defaultValue: this.state.form.academic_year_start }), _react2.default.createElement(_reactstrap.FormFeedback, null, fieldError("Academic year start"))), _react2.default.createElement(_reactstrap.FormGroup, null, _react2.default.createElement(_reactstrap.Label, null, "Academic Year End"), _react2.default.createElement(_reactstrap.Input, { placeholder: "Academic Year End",
                value: academicYearEnd,
                disabled: true }), _react2.default.createElement(_reactstrap.FormFeedback, null, fieldError("Academic year start"))), _react2.default.createElement("br", null), _react2.default.createElement("h5", { className: "mb-3" }, "Terms"), _react2.default.createElement(_reactstrap.FormGroup, null, _react2.default.createElement(_reactstrap.Label, null, "Term 1 Start"), _react2.default.createElement(_reactstrap.Input, { type: "date",
                onChange: this.getTermChangeHandler(term1, "start_date"),
                valid: isValid("Term 1 start date"),
                defaultValue: term1.start_date }), _react2.default.createElement(_reactstrap.FormFeedback, null, fieldError("Term 1 start date"))), _react2.default.createElement(_reactstrap.FormGroup, null, _react2.default.createElement(_reactstrap.Label, null, "Term 1 End"), _react2.default.createElement(_reactstrap.Input, { type: "date",
                onChange: this.getTermChangeHandler(term1, "end_date"),
                valid: isValid("Term 1 end date"),
                defaultValue: term1.end_date }), _react2.default.createElement(_reactstrap.FormFeedback, null, fieldError("Term 1 end date"))), _react2.default.createElement("br", null), _react2.default.createElement(_reactstrap.FormGroup, null, _react2.default.createElement(_reactstrap.Label, null, "Term 2 Start"), _react2.default.createElement(_reactstrap.Input, { type: "date",
                onChange: this.getTermChangeHandler(term2, "start_date"),
                valid: isValid("Term 2 start date"),
                defaultValue: term2.start_date }), _react2.default.createElement(_reactstrap.FormFeedback, null, fieldError("Term 2 start date"))), _react2.default.createElement(_reactstrap.FormGroup, null, _react2.default.createElement(_reactstrap.Label, null, "Term 2 End"), _react2.default.createElement(_reactstrap.Input, { type: "date",
                onChange: this.getTermChangeHandler(term2, "end_date"),
                valid: isValid("Term 2 end date"),
                defaultValue: term2.end_date }), _react2.default.createElement(_reactstrap.FormFeedback, null, fieldError("Term 2 end date"))), _react2.default.createElement("br", null), _react2.default.createElement(_reactstrap.FormGroup, null, _react2.default.createElement(_reactstrap.Label, null, "Term 3 Start"), _react2.default.createElement(_reactstrap.Input, { type: "date",
                onChange: this.getTermChangeHandler(term3, "start_date"),
                valid: isValid("Term 3 start date"),
                defaultValue: term3.start_date }), _react2.default.createElement(_reactstrap.FormFeedback, null, fieldError("Term 3 start date"))), _react2.default.createElement(_reactstrap.FormGroup, null, _react2.default.createElement(_reactstrap.Label, null, "Term 3 End"), _react2.default.createElement(_reactstrap.Input, { type: "date",
                onChange: this.getTermChangeHandler(term3, "end_date"),
                valid: isValid("Term 3 end date"),
                defaultValue: term3.end_date }), _react2.default.createElement(_reactstrap.FormFeedback, null, fieldError("Term 3 end date"))))), _react2.default.createElement(_reactstrap.ModalFooter, null, _react2.default.createElement(_reactstrap.Button, { outline: true,
                color: "success",
                disabled: formHasErrors }, this.props.edit ? "Save changes" : "Add")));
        }
    }], [{
        key: "yearIsValid",
