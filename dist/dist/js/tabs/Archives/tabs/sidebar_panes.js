...
var StudentSidebarPane = function (_Component) {
    ...
    _createClass(StudentSidebarPane, [{
        ...
        value: function render() {
            ...
            if (isFetched) {
                pageBody = _react2.default.createElement("div", { className: "page-body" }, _react2.default.createElement(_student_detail_overview.StudentDetailOverview, { sidebar: true, student: student }), _react2.default.createElement(_student_detail_overview.StudentContact, { sidebar: true, student: student }), _react2.default.createElement(_student_detail_overview.StudentUniversity, { sidebar: true, student: student }));
            } else {
                pageBody = _react2.default.createElement(_loading2.default, null);
            }

            return _react2.default.createElement("div", { className: "p-0 h-100 d-flex flex-column" }, _react2.default.createElement("div", { className: "page-head pt-5 d-flex flex-row align-items-end" }, _react2.default.createElement("div", { className: "mr-auto" }, _react2.default.createElement("h5", { className: "mb-0" }, fullName))), pageBody);
        }
    }]);
