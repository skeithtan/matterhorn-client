...
var Section = function (_Component) {
    ...
    _createClass(Section, [{
        ...
        value: function render() {
            return _react2.default.createElement("div", { className: "section" }, this.props.children);
        }
    }]);
...
var SectionTitle = function (_Component2) {
    ...
    _createClass(SectionTitle, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement("small", { className: "section-title" }, this.props.children);
        }
    }]);
...
var SectionFooter = function (_Component3) {
    ...
    _createClass(SectionFooter, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement("small", { className: "section-footer" }, this.props.children);
        }
    }]);
...
var SectionTable = function (_Component4) {
    ...
    _createClass(SectionTable, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(_reactstrap.ListGroup, { className: this.props.className }, this.props.children);
        }
    }]);
...
var SectionRow = function (_Component5) {
    ...
    _createClass(SectionRow, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(_reactstrap.ListGroupItem, { onClick: this.props.onClick, className: "section-row " + (this.props.className || ""),
                active: this.props.active, action: this.props.selectable }, this.props.children);
        }
    }]);
...
var SectionRowTitle = function (_Component6) {
    ...
    _createClass(SectionRowTitle, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement("small", { className: "font-weight-bold" }, this.props.children);
        }
    }]);
...
var SectionRowContent = function (_Component7) {
    ...
    _createClass(SectionRowContent, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement("p", { className: "m-0 " + (this.props.className || "") + " " + (this.props.large ? "lead" : ""),
