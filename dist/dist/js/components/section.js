...
var Section = function (_Component) {
    ...
    _createClass(Section, [{
        ...
        value: function render() {
            return _react2.default.createElement("div", { className: "section " + (this.props.collapsed && "collapsed") }, this.props.children);
        }
    }]);
...
var SectionRow = function (_Component5) {
    ...
    _createClass(SectionRow, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(_reactstrap.ListGroupItem, { onClick: this.props.onClick,
                className: "section-row " + (this.props.className || "") + " " + (this.props.collapsed && "collapsed"),
                active: this.props.active,
                action: this.props.selectable }, this.props.children);
        }
    }]);
