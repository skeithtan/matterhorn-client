...
var CollapseContent = function (_Component) {
    ...
    _createClass(CollapseContent, [{
        ...
        value: function render() {
            return _react2.default.createElement("div", { className: "collapse-content", onClick: this.props.expand }, _react2.default.createElement("img", { src: "./images/expand.png", className: "expand-image" }), _react2.default.createElement("h4", null, this.props.title));
        }
    }]);
...
var ExpandContent = function (_Component2) {
    ...
    _createClass(ExpandContent, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement("div", { className: "expand-content" }, this.props.children);
        }
    }]);
