...
var LinkageList = function (_Component) {
    ...
    _createClass(LinkageList, [{
        ...
        value: function render() {
            return _react2.default.createElement("div", { className: "sidebar h-100", id: "linkage-list" }, _react2.default.createElement(LinkageListHead, null), _react2.default.createElement(LinkageListTable, null));
        }
    }]);
...
var LinkageListHead = function (_Component2) {
    ...
    _createClass(LinkageListHead, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement("div", { className: "page-head pt-5 d-flex flex-column align-items-center" }, _react2.default.createElement("div", { className: "d-flex flex-row w-100 mb-2 align-items-center" }, _react2.default.createElement("div", { className: "mr-auto" }, _react2.default.createElement("h5", { className: "mb-0 text-secondary" }, "Linkages"), _react2.default.createElement("h4", { className: "page-head-title mb-0" }, "Institution name"))), _react2.default.createElement(_reactstrap.Input, { type: "search", placeholder: "Search", className: "search-input" }));
        }
    }]);
...
var LinkageListTable = function (_Component3) {
    ...
    _createClass(LinkageListTable, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement("div", { className: "page-body" }, _react2.default.createElement(_section.SectionTable, null, _react2.default.createElement(LinkageListRow, null), _react2.default.createElement(LinkageListRow, null), _react2.default.createElement(LinkageListRow, null), _react2.default.createElement(LinkageListRow, null)));
        }
    }]);
...
var LinkageListRow = function (_Component4) {
    ...
    _createClass(LinkageListRow, [{
        key: "render",
        value: function render() {
            return _react2.default.createElement(_section.SectionRow, null, "Linkage Name");
        }
    }]);
